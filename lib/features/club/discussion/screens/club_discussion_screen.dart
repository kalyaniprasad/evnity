...
import '../../../../core/providers/student_providers.dart'; // To reuse currentUserProvider
...
class _ClubDiscussionScreenState extends ConsumerState<ClubDiscussionScreen> {
  ...
  void _send() {
    ...
    ref.read(clubDiscussionHelperProvider).sendMessage(widget.eventId, text);
    _inputCtrl.clear();
  ...
  Widget build(BuildContext context) {
    final messagesAsync = ref.watch(
      clubDiscussionStreamProvider(widget.eventId),
    );
              ...
              data: (messages) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (ctx, i) {
                    ...
                    final isMe =
                        msg.senderType == MessageSenderType.organizer &&
