...
class ClubNotificationsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isProfileIncomplete = ref.watch(isClubProfileIncompleteProvider);
                    ...
                    if (isProfileIncomplete)
                      const SliverToBoxAdapter(
                        child: Padding(
                          ...
                          child: _ClubProfileCompletionBanner(),
                        ),
                      ),
...
class _ClubProfileCompletionBanner extends StatelessWidget {
  const _ClubProfileCompletionBanner();
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      context.push('/club/profile/edit');
                    },
